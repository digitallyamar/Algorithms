#A simple algorithm that implements the ceasar cipher by shifting entered text by a number of letters(keys) to produce an encryted output.
...
print('\nYour encrypted text is: ', translated_text)
